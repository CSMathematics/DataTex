...
CREATE TABLE IF NOT EXISTS "BibEntries_per_Document" (
	"Bib_Id"	TEXT,
	"Document_Id"	TEXT,
	"Bib_Database_Source"	TEXT
);end_of_query
CREATE TABLE IF NOT EXISTS "CustomTags" (
	"Tag"	TEXT,
	PRIMARY KEY("Tag")
);end_of_query
CREATE TABLE IF NOT EXISTS "Tags_per_Document" (
	"Tag_Id"	TEXT,
	"Document_Id"	TEXT,
	FOREIGN KEY("Document_Id") REFERENCES "Documents"("Id") ON UPDATE CASCADE ON DELETE CASCADE,
...
CREATE TABLE IF NOT EXISTS "Edit_History" (
	...
	"Metadata"	TEXT,
	"Files_Included"	TEXT,
	FOREIGN KEY("File_Id") REFERENCES "Documents"("Id") ON DELETE CASCADE ON UPDATE CASCADE
);end_of_query
