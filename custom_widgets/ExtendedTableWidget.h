...
public slots:
    void reloadSettings();
    void selectTableLine(QString text, int column);
    void openPrintDialog();
    void setFilter(size_t column, const QString& value);
    void filterTable(QString query, QSqlDatabase database, bool isSorted);
