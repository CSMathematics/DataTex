...
void FilterTableHeader::generateFilters(size_t number, size_t number_of_hidden_filters)
{
    ...
    for(size_t i=0;i < number; ++i)
    {
        ...
        connect(l, &FilterLineEdit::delayedTextChanged, this, &FilterTableHeader::inputValues);
        connect(l, &FilterLineEdit::delayedTextChanged, this, &FilterTableHeader::adjustPositions);
...
void FilterTableHeader::inputValues()
{
//    QStringList values;
//    int size = static_cast<int>(filterWidgets.size());
//    for (int i=0;i<filterWidgets.size();i++) {
//        values.append(filterWidgets.at(i)->text());
//    }
    emit filterValues(getFilterValues());
}
...
QStringList FilterTableHeader::getFilterValues()
{
    QStringList values;
    for (int i=0;i<filterWidgets.size();i++) {
        values.append(filterWidgets.at(i)->text());
