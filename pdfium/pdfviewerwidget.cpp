...
PdfViewerWidget::PdfViewerWidget( const QString fileName,QWidget* parent)
    : QWidget( parent)
{
    pdf_file=fileName;
    lastFile=fileName;
    ...
    CentralLayoutBis->setContentsMargins(0,0,0,0);
...
#else
listpagesWidget->setFixedWidth(30+fm.horizontalAdvance(QString::number(100)));
#endif
path= QPainterPath();
altern=1;
currentScale=1;
...
#else
  listpagesWidget->setFixedWidth(30+fm.horizontalAdvance(QString::number(pdfview->doc()->pageCount())));
#endif
...
void PdfViewerWidget::scaleModified()
{
