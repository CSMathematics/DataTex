...
//        FileCommands::BuildDocument(DataTex::LatexCommands[results.BuildCommand],results.Path
...
//        if(rem == " files"){
//            DBFileInfo fileInfo = DBFileInfo(results.Id,currentBase);
//            DBFileInfo::WriteDBFile(fileInfo);
//        }
//        else if(rem == " documents"){
//            DBDocInfo docInfo = DBDocInfo(results.Id,currentBase);
