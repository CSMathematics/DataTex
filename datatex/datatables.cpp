    ...
    , ui(new Ui::DataTables)
{
    ...
    currentbase_Notes = DataTex::CurrentDocumentDataBase;
    ...
    ui->DocsDBCombo->setCurrentText(DataTex::GlobalDocsDatabaseListNames[QFileInfo(DataTex::CurrentDocumentDatabasePath).baseName()]);
