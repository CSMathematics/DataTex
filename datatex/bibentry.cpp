...
BibEntry::BibEntry(QWidget *parent, bool EditMode, bool InsertMode, QHash<QString,QString> values) :
    QDialog(parent),
    ui(new Ui::BibEntry)
{
    ui->setupUi(this);
    ...
    if(isInsertMode){BibEditMode();}
    ui->buttonBox->setHidden(isInsertMode);
}
