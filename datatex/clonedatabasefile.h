...
//    void on_checkBox_clicked(bool checked);
    ...
    bool CheckMetadataResemblances(DTXFile * fileInfo,QSqlDatabase destinationDatabase);
    void ActionsWidget(QTreeWidgetItem * item, bool hassResemb);
    void ShowReseblences(DTXFile * fileInfo);

private:
    Ui::CloneDatabaseFile *ui;
    DTXDatabase SourceDatabase;
    DTXDatabase DestinationDatabase;
    ...
    QList<DTXFile *> FileList;
    QList<DTXFile *> SolutionsList;
...
signals:
    ...
    void sendResemblenceInfo(DTXFile fileInfo);
};
